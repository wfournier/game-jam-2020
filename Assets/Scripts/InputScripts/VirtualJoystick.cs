...
namespace Assets.Scripts.InputScripts
{
    public class VirtualJoystick : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (!(UnityEngine.Input.mousePosition.x < screenMiddle))
            {
            ...
            {
                _pointA = (new Vector2(UnityEngine.Input.mousePosition.x, UnityEngine.Input.mousePosition.y));
            ...
            {
                _touchStart = true;
                _pointB = (new Vector2(UnityEngine.Input.mousePosition.x, UnityEngine.Input.mousePosition.y));
            }
            else
            {
                _touchStart = false;
